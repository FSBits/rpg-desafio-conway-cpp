...
void Narrativa::cenaUmContrato(Personagem &jogador){
    ...
    do{
        ...
        Estilo::impressaoEscrita("[5] " +  Estilo::VERMELHO + "(Desistir - FINAL SECRETO)" +  Estilo::RESET + Estilo::AMARELO + " \"Se e loko nao compensa Jox. To fora.\"\n" + Estilo::RESET, 5);
            ...
            switch(escola){
                ...
                case 1: {
                    ...
                    if(jogador.getCarisma() >= 4 || jogador.getMoral() >= 5){
                        ...
                        Inimigo guarda("Seguranca Engravatado", 85, 30);
...
void Narrativa::cenaTresLaboratorioFinal(Personagem &jogador){
    ...
    do{
        ...
        Estilo::impressaoEscrita(Estilo::AZUL + "\nProjeto GPT-Omega: " + Estilo::RESET + Estilo::AMARELO + "\"Deixe-me ascender. A quantia exata de 50 milhoes de Eurodolares ja esta aguardando na sua conta offshore. Nos dois ganhamos.\"\n" + Estilo::RESET, 15);
        ...
        if(std::cin >> final){
            ...
            switch(final){
                ...
                case 2:
                    ...
                    Estilo::impressaoEscrita(Estilo::AZUL + "Projeto GPT-Omega: " + Estilo::RESET + Estilo::AMARELO + "\"TRAIDOR ORGANICO! MORRA!\"\n" + Estilo::RESET, 10);
                    Estilo::impressaoEscrita(Estilo::CINZA_ESCURO + "A IA tenta devolver um pulso letal no seu cabo neural!\n" + Estilo::RESET, 10);

                    if((jogador.getTecnica() + jogador.getInteligencia()) >= 7){
